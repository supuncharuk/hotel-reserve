            ...
            <div class="card-body">
                <form action="" class="needs-validation" method="post" novalidate>
                    ...
                    <div class="form-group pt-1">
                        <input type="submit" class="btn btn-block btn-primary btn-xl" value="Send Reset Link">
                    </div>
                </form>
            </div>
            <!-- <div class="card-footer text-center">
                <span>Don't have an account? <a href="create-uaccount.php">Create Account</a></span>
            </div> -->
        </div>
    </div>
    <!-- ============================================================== -->
